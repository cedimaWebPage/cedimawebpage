...
const BENEFITS = [
  {
    ...
    desc: "1 titular más hasta 8 beneficiarios cubiertos con todos los beneficios VIP del plan.",
  },
  {
    icon: "🩺",
    bg: "#d0f4ea",
    title: "Medicina general gratis todo el año",
    desc: "Consultas ilimitadas de medicina general sin costo adicional para el titular y beneficiarios.",
  },
  {
    icon: "💊",
    bg: "#e0f7ef",
    title: "Hasta 50% en especialidades",
    desc: "Descuento del 50% en la primera consulta en Medicina Interna, Urología, Ginecología, Dermatología y Nutrición.",
  },
  {
    icon: "⭐",
    bg: "#fef9c3",
    title: "Tarifas VIP exclusivas",
    desc: "Acceso a las tarifas más bajas de la red para procedimientos, consulta especializda, cirugías programadas e imágenes diagnósticas.",
  },
  {
    icon: "🏥",
    bg: "#fde8ee",
    title: "Red ampliada de clínicas",
    desc: "Cobertura en todas las sedes Cedima y en una red ampliada de clínicas, laboratorios y especialistas aliados.",
  },
  {
    icon: "🎁",
    bg: "#d4f0df",
...
const FAQS = [
  {
    q: "¿Cuál es la diferencia entre el VIP y el plan Familiar estándar?",
    a: "El plan VIP incluye consultas de medicina general gratis todo el año (sin límite), tarifas VIP exclusivas más bajas que el plan familiar y bonos de descuento deñ 50% en más especialidades.",
  },
  {
    q: "¿Las consultas ilimitadas aplican para todos los beneficiarios?",
    a: "Sí, las consultas de medicina general sin costo aplican para el titular y todos los beneficiarios registrados en el plan.",
  },
  {
    q: "¿Cómo se activan los bonos de descuento en especialidades?",
    a: "Los bonos se activan automáticamente al momento de registrar tu cita. Solo necesitas indicar que eres miembro VIP Cedima y presentar tu documento de identidad.",
  },
  {
    q: "¿Puedo usar el plan en otra ciudad?",
    a: "Sí. El plan VIP tiene cobertura en todas las sedes Cedima del país y en la red ampliada de aliados. Consulta la sede más cercana en nuestra web o línea de atención.",
  },
  {
    q: "¿El plan se puede financiar?",
    a: "El Paquete VIP requiere pago único anual. Si prefieres un plan con opción de financiación, te recomendamos el Paquete Elite que es financiable hasta en 24 cuotas.",
  },
];
    ...
    <>
          ...
          <div className="pkg-hero__inner">
            <div>
              ...
              <p className="pkg-hero__desc">
                La experiencia premium de salud familiar. Consultas de medicina
                general gratuitas todo el año, tarifas VIP exclusivas y
                cobertura completa para hasta 8 beneficiarios.
              </p>
            ...
            <div className="pkg-price-card" style={{ borderColor: "#c4b5fd" }}>
              ...
              {[
                ...
                "Bonos de 50% de descuento en especialidades",
                "Tarifas VIP exclusivas",
      ...
      <section className="pkg-section">
        <div className="container">
          ...
          <h2 className="pkg-section__title">
            La experiencia de salud más completa
          </h2>
          <p className="pkg-section__sub">
            Todo lo del plan familiar estándar, más consultas de medicina
            general ilimitadas y beneficios exclusivos para toda la familia.
          </p>
      ...
      <section className="pkg-section pkg-section--alt" id="servicios">
        <div className="container">
          ...
          <p className="pkg-section__sub">
            La cobertura más amplia de la línea Cedima para toda tu familia.
          </p>
      ...
      <section className="pkg-section">
        <div className="container">
          ...
          <h2 className="pkg-section__title">
            ¿Tienes dudas sobre el plan VIP?
          </h2>
          <p className="pkg-section__sub">
            Resolvemos las preguntas más comunes sobre el Paquete Médico
            Familiar VIP.
          </p>
          <FAQ items={FAQS} />
        </div>
        ...
        <div className="pkg-cta">
          <div className="pkg-cta__text">
            <h3 className="pkg-cta__title">
              Dale a tu familia la mejor atención ✨
            </h3>
            <p className="pkg-cta__sub">
              Activa tu plan VIP hoy y accede a consultas gratis todo el año.
            </p>
          </div>
          <div className="pkg-cta__actions">
            <a
              href={MERCADOPAGO_LINKS.vip}
              className="btn btn-primary"
              target="_blank"
